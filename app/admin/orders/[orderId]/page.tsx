      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-2 xs:p-3 sm:p-4 md:p-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-md p-3 xs:p-4 sm:p-6 text-center">
            ...
            <Link
              href="/admin/orders"
              className="px-4 py-2.5 xs:py-2.5 bg-slate-800 text-white rounded-lg active:bg-slate-700 xs:hover:bg-slate-700 md:hover:bg-slate-700 text-xs xs:text-sm sm:text-base min-h-[44px] inline-flex items-center justify-center touch-manipulation"
            >
              ត្រលប់
            </Link>
          </div>
          ...
          <div className="max-w-7xl mx-auto w-full">
            <div className="flex flex-col gap-2 xs:gap-3 sm:gap-2 sm:flex-row sm:justify-between sm:items-start mb-3 xs:mb-4 sm:mb-4 md:mb-6">
              <div className="flex-1 min-w-0 space-y-1 xs:space-y-2 sm:space-y-2">
                ...
                {orderData.table && (
                  <div className="px-2 xs:px-3 py-1 xs:py-1.5 sm:py-1.5 bg-slate-800 text-white rounded-lg text-[10px] xs:text-xs sm:text-xs md:text-sm font-medium inline-block break-words">
