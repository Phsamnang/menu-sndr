      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-primary text-white rounded-lg hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors"
          >
            {isSubmitting
              ? "កំពុងដំណើរការ..."
              : editingExpense
