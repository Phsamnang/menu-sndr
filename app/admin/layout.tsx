...
const I = {
  ...
  tableTypes: (
    <svg viewBox="0 0 24 24">
      <path d="M20.59 13.41L13 21a2 2 0 0 1-2.83 0L2 12.83V2h10.83L21 10.17a2 2 0 0 1-.41 3.24z" />
...
export default function AdminLayout({
  ...
  const menuItems: MenuItem[] = [
    ...
    { href: "/admin/categories", title: "មីនុយ", icon: I.categories, allowedRoles: ["admin"], section: "setup" },
    { href: "/admin/menu-items", title: "មុខម្ហូប", icon: I.menuItems, allowedRoles: ["admin"], section: "setup" },
    { href: "/admin/tables", title: "តុ", icon: I.tables, allowedRoles: ["admin"], section: "setup" },
    { href: "/admin/table-types", title: "ប្រភេទតុ", icon: I.tableTypes, allowedRoles: ["admin"], section: "setup" },
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-auto flex flex-col">
        <div className="lg:hidden bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between flex-shrink-0">
          ...
          >
            <span className="nav-icon">{I.menu}</span>
          </button>
